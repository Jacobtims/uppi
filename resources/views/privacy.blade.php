...
<head>
    ...
    <title>Uppi privacy policy</title>

    @vite('resources/css/app.css')
</head>
<body class="bg-gray-100 text-gray-800">
<div class="container mx-auto px-4 py-8">
    <img src="{{ asset('logo.svg') }}" alt="Uppi" class="w-24 mb-8">
    ...
    <section>
        ...
        <p class="mb-4">
            This Privacy Policy explains how <strong>Uppi</strong> ("we", "us", "our"), a service maintained and
            operated by
    ...
    <section>
        ...
        <p class="mb-4">Webmethod acts as the data controller for personal information collected through Uppi.</p>
    </section>
    ...
    <section>
        ...
        <h3 class="text-xl font-medium mb-2">3.2 Monitor Data</h3>
        <ul class="list-disc ml-6 mb-4">
            <li>URLs and IP addresses of monitored endpoints</li>
            <li>Response times</li>
            <li>Status codes</li>
            <li>Uptime statistics</li>
            <li>Check results and anomaly data</li>
        </ul>
