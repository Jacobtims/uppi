<div class="space-y-6">
    <div class="text-center">
        <div class="flex justify-center mb-4">
            <x-heroicon-o-device-phone-mobile class="w-16 h-16 text-primary-500" />
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <a href="https://testflight.apple.com/join/Dj83spPj" class="flex items-center justify-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-500 gap-2">
        ...
        <a href="https://play.google.com/store/apps/details?id=dev.uppi.app" class="flex items-center justify-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-gray-800">
            <svg class="w-8 h-8 mr-2" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="mt-6 text-center">
        ...
        <a href="{{ $personal_access_tokens_url }}" class="inline-flex items-center justify-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-500 gap-2">
            <x-heroicon-m-key class="w-5 h-5 mr-2" />
